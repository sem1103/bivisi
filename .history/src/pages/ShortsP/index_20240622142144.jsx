...
const Shorts = () => {
  ...
  let videoProducts= product?.results?.filter((item) => item.product_video_type[0]?.product_type === "Shorts") || [];
  ...
  const { user } = useContext(AuthContext);
    ...
    useEffect(() => {
      setTimeout(() => {
        setShorts(product?.results?.filter((item) => item.product_video_type[0]?.product_type === "Shorts"))
        console.log(shorts);
      }, 500);
