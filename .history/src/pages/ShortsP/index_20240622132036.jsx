...
const Shorts = () => {
  ...
  let [videoProducts, setVideoProducts] = useState([]);
  ...
  const { user } = useContext(AuthContext);
    ...
    useEffect(() => {
       ...
       setVideoProducts(product?.results?.filter(
        (item) => item.product_video_type[0]?.product_video_type.product_type    === "Shorts")) 
