                ...
                <div className="chat__title">
...

                  {
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path d="M10 5V15M15 10L5 10" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                  :
                  ''
...
<path d="M17.5 15.8333V14.4617C17.5 13.7802 17.0851 13.1674 16.4523 12.9143L14.7572 12.2362C13.9524 11.9143 13.0352 12.263 12.6475 13.0383L12.5 13.3333C12.5 13.3333 10.4167 12.9167 8.75 11.25C7.08333 9.58333 6.66667 7.5 6.66667 7.5L6.96168 7.35249C7.73698 6.96484 8.08571 6.04761 7.76379 5.2428L7.08574 3.54768C6.83263 2.91492 6.21979 2.5 5.53828 2.5H4.16667C3.24619 2.5 2.5 3.24619 2.5 4.16667C2.5 11.5305 8.46954 17.5 15.8333 17.5C16.7538 17.5 17.5 16.7538 17.5 15.8333Z" stroke="var(--textColor)" strokeWidth="1.5" stroke-linejoin="round"/>
                      ...
                      {/* <img src={camera} alt="" /> */}
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.66602 6.66634C1.66602 4.82539 3.1584 3.33301 4.99935 3.33301H10.8327C12.6736 3.33301 14.166 4.82539 14.166 6.66634V13.333C14.166 15.174 12.6736 16.6663 10.8327 16.6663H4.99935C3.1584 16.6663 1.66602 15.174 1.66602 13.333V6.66634Z" stroke="var(--textColor)" strokeWidth="1.5"/>
<path d="M14.166 7.77745L15.4501 6.40774C16.4835 5.30548 18.3327 6.03675 18.3327 7.54764V12.4517C18.3327 13.9626 16.4835 14.6939 15.4501 13.5916L14.166 12.2219V7.77745Z" stroke="var(--textColor)" strokeWidth="1.5"/>
<path d="M10.8327 8.33301C10.8327 9.25348 10.0865 9.99968 9.16602 9.99968C8.24554 9.99968 7.49935 9.25348 7.49935 8.33301C7.49935 7.41253 8.24554 6.66634 9.16602 6.66634C10.0865 6.66634 10.8327 7.41253 10.8327 8.33301Z" stroke="var(--textColor)" strokeWidth="1.5"/>
</svg>
