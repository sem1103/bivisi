...
const Chat = () => {
  ...
  const { USER_TOKKEN, myId, CHAT_API, allChats, chatId, messages,setMessages, newMessage, lastMessages, setNewMessage, socket, newChatUser, onlineUsers, sendMessage, getMessage, addChat, getChats } = useContext(ChatContext)
              ...
              {(newChatUser) && (
                <div className="chat_messages_header">
                  <div className="d-flex align-items-center gap-3 message__user">
                    <div className="nickname">
                      <img src={newChatUser.avatar} alt="" />
              ...
              {(messages.some(item => item.chatId == chatId) || newChatUser) && (
                <div >
                  ...
                  <form className="chat_messages_footer" onSubmit={(e) => {
                    ...
                    <textarea value={newMessage} name="newMessage" id="new__message" placeholder="Write a message" onChange={e => setNewMessage(e.target.value)} style={{ height: '50px', minHeight: 'unset', resize: 'none' }} />
                    <button>
