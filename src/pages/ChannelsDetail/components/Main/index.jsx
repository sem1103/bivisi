      ...
      <div className="channels_info">
        ...
        <div className="chanell__tools">
          <button onClick={() => {
            ...
            setIsOpen(!isOpen)
            if (allChats.find(chat => +chat.target.userId == +channelData.id)) {
              getMessage(allChats.find(chat => +chat.target.userId == +channelData.id).chatId)
              ...
              addChat({
                ...
                firstName: channelData.first_name,
                lastName: channelData.last_name,
          ...
          <Modal
            ...
            className={'modal__body chanel__chat'}
            styles={{
              mask: {
          ...
          >
            <div className="chat_section messages__display " style={{overflow: 'hidden'}}>
