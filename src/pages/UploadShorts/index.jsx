...
const UploadS = () => {
  ...
  const TOKEN =
    "pk.eyJ1Ijoic2VtMTEwMyIsImEiOiJjbHhyemNmYTIxY2l2MmlzaGpjMjlyM3BsIn0.CziZDkWQkfqlxfqiKWW3IA"; // Set your mapbox token here
              ...
              <div className="steps">
                ...
                <div className="step">
                  <div className="completed_part have__video">
                    <div
                      className={`white_part active__step ${
                        haveVideo ? "active__step" : ""
                      }`}
                ...
                <div className="step">
                  <div
                    className={`completed_part ${
                      videoPreview ? "have__video" : ""
                    }`}
                  >
                    <div
                      className={`white_part ${
                        videoPreview ? "active__step" : ""
                      }`}
                      style={{ display: `${videoPreview ? "block" : ""}` }}
                    ></div>
                    {/* <FaCheck
                  ...
                  {!showProgressBar && !haveVideo && (
                    <>
                      ...
                      <div className="upload__desc">
                        ...
                        <p>
                          Your short videos will be private until you publish
                          them.
                        </p>
                      </div>
                  ...
                  <div className={`${!videoPreview ? "disabled" : ""}`}>
                    ...
                    <div className="input_data">
                      ...
                      <div className="file_price">
                        ...
                        />
                        <span className="countryCurrencySymbol">
                          {currency.countryCurrencySymbol}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="input_data">
                      <label htmlFor="category">
                        Category (Add category to your video)
                      </label>
                    ...
                    <div className="input_data thumbernails">
                      ...
                      <div className="thumbernails__wrapper">
                        ...
                        <ul className="thumbernail__items">
                          <li>
                            <img src={thumbnail[1]} alt="" />
                          </li>
                          <li>
                            <img src={thumbnail[2]} alt="" />
                          </li>
                          <li>
                            <img src={thumbnail[3]} alt="" />
                          </li>
                          <li>
