        ...
        <div className="search">
          <div className="d-flex align-items-center gap-3 search_content">
            <svg className="search_img" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g id="Icon/Search" clip-path="url(#clip0_282_2108)">
            ...
            <button className="microphone" onClick={handleVoiceInput}>
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Icon/Microphone/Outline">
                  <path id="Vector" d="M15.8332 9.16663V9.99996C15.8332 13.2216 13.2215 15.8333 9.99984 15.8333M4.1665 9.16663V9.99996C4.1665 13.2216 6.77818 15.8333 9.99984 15.8333M9.99984 15.8333V18.3333M9.99984 18.3333H12.4998M9.99984 18.3333H7.49984M9.99984 13.3333C8.15889 13.3333 6.6665 11.8409 6.6665 9.99996V4.99996C6.6665 3.15901 8.15889 1.66663 9.99984 1.66663C11.8408 1.66663 13.3332 3.15901 13.3332 4.99996V9.99996C13.3332 11.8409 11.8408 13.3333 9.99984 13.3333Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                </g>
              </svg>
