...
const Header = ({ isOpen }) => {
  ...
  const {t} = useTranslation(['sidebarMenu', 'topHeader'])
...
function getFormattedDate() {
            ...
            return [
                {
                    ...
                    comment_id: eventObj.comment_id ? eventObj.comment_id : ''
                },
                ...prev
            ]
        });
  ...
  const handleCommentScroll = () => {
    ...
    if (element.scrollHeight - element.scrollTop === element.clientHeight) {
      onScrollEnd(); // Вызов функции при достижении конца скролла
    }
  };
  ...
  if (
    ...
    return (
      <>
      <CModal
      className="call__modal__wrapper"
alignment="top"
visible={isModalCallOpen}
onClose={() => {
  ringtoneRef.current.currentTime = 0; // Сброс времени воспроизведения
  ringtoneRef.current.pause();
  declineCall()
...
</h3>
{
                      ...
                      {isUploadOptionsVisible && (
                        <div className="upload-options">
                          ...
                          >
                            ...
                            {t('uploadMenu.name1', { ns: 'topHeader' })}
                          </Link>
                          <Link
  ...
  <svg width={18} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="content_left d-flex align-items-center justify-content-end gap-3">
                  <NavLink to="/login" className="login-btn shadow__btn">
                    <img src={login} alt="" />
                    Login
                  </NavLink>
                </div>
...
<path id="Vector" d="M11.6667 10.5C11.6667 9.21134 12.7113 8.16667 14 8.16667C15.2887 8.16667 16.3333 9.21134 16.3333 10.5C16.3333 10.9645 16.1976 11.3973 15.9636 11.7609C15.2663 12.8446 14 13.878 14 15.1667V15.75M14 18.6667V19.8333M3.5 10.654V17.3461C3.5 19.1233 4.42436 20.7656 5.92487 21.6542L11.5751 25.0003C13.0756 25.8889 14.9244 25.8889 16.4249 25.0003L22.0751 21.6542C23.5756 20.7656 24.5 19.1233 24.5 17.3461V10.654C24.5 8.87674 23.5756 7.23453 22.0751 6.34592L16.4249 2.99983C14.9244 2.11122 13.0756 2.11122 11.5751 2.99983L5.92487 6.34592C4.42436 7.23452 3.5 8.87674 3.5 10.654Z" stroke="#A2A8B7" strokeWidth="1.5" strokeLinecap="round"/>
              ...
              <div className="link-column">
                ...
                <br />
                <NavLink to="/developers"> { t('footer.name6')}</NavLink>
              </div>
              ...
              <div className="footer-copy">
                <p>
                { t('footer.copyRight.name1')} <br />
                { t('footer.copyRight.name2')}
                </p>
              </div>
                    </footer>
                  ) : (
              ...
              <div className="burger_menu d-flex align-content-center w-100 gap-2">
                <Search setIsUploadOptionsVisible={setIsUploadOptionsVisible}  />
                {
                  user ? (
                    ...
                    <NavLink to="/login" className=" sm_login shadow__btn">
                      <img src={login} alt="" />
                      Login
                    </NavLink>
                  )
